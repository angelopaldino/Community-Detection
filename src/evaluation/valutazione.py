...
part4 = np.load("C:\\Users\\angel\\OneDrive\\Desktop\\Community Detection LLM\\experiments\\results\\part3.npy")
...
r_part4 = valuta_partizione("Partizione 4", part4, etichette, grafo)
